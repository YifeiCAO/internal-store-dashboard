...
> ICLR 风格模型设计与预注册实验计划，评审合并冻结稿 v9，2026-07-14
...
| M1j pilot/G3 | Frozen M1i + 77 参数 bounded transport residual；随后只读首次更新审计 | 检验均匀 sensory CE 能否学会 context 精确运输并定位失败信用 | source/disabled 0.7344，M1j 0.0781；G3 聚合 cosine -0.9579，但逐 batch 负向仅 9/16，分类 MIXED，先做 probe 级审计 |
