...
截至 2026-07-13，原 M1 的 raw 与 EMA arm 均只有 `2/3` seeds 通过，因此原 M2/M3 路线仍停止。随后冻结诊断定位到 HPC 内容串扰，单机制 M1b 已通过三 seed substrate gate 与预算匹配 Hippoformer 终审；这不追溯修改原 M1 停止结论。当前正式模型为未额外微调的 frozen converted M1b。
